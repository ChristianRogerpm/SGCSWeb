                    ...
                    <div class="tabbable-custom ">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="InfoProyecto">
                                @include('JefeProyecto.ContenidoPestaña.FrmPestañaEquipo')
                            </div>
                                        ...
                                        <div class="portlet-body">
                                            <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_1">
                                                ...
                                                @foreach($xGstringUsuarioProyecto as $xGstringUsuarioProyectos)
                                                    <tr>
                                                        <td>{{$xGstringUsuarioProyectos->fncRelacionUsuario->USUnombre_usuario}}</td>
                                                        <td>
                                                            @if($xGstringUsuarioProyectos->USUPROestado_usuarioproyecto == 1)
                                                        ...
                                                        <td>
                                                            <div class="btn-group pull-right">
                                                                ...
                                                                <ul class="dropdown-menu pull-right">
                                                                    <li>
                                                                        <a href="{{route('RetirarUsuarioProyecto',$xGstringUsuarioProyectos->USUPROid_usuarioproyecto)}}">
