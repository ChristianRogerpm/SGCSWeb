<div class="row">
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{route('AsignarTarea')}}" method="post" class="horizontal-form">
            <div class="form-body">
                <div class="row">
                    {{csrf_field()}}
                    @if ($errors->any())
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-large date-picker input-daterange" data-date="2012/11/10" data-date-format="yyyy/mm/dd">
                                    <input type="text" class="form-control" name="ATPfecha_inicio_tareaproyecto" placeholder="F. Inicio" value="">
                                    <span class="input-group-addon"> a </span>
                                    <input type="text" class="form-control" name="ATPfecha_fin_tareaproyecto" placeholder="F. Fin" value="">
                                </div>
                            </div>
                            <div class="form-group">
