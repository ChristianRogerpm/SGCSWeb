                    ...
                    <div class="tabbable-custom ">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="InfoProyecto">
                                @include('JefeProyecto.ContenidoPestaña.FrmPestañaComiteCambio')
                            </div>
                                    ...
                                    <div class="portlet box blue">
                                        ...
                                        <div class="portlet-body">
                                            <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_1">
                                                ...
                                                <tbody>
                                                @foreach($xGstringComiteCambio as $xGstringComiteCambios)
                                                <tr>
                                                    <td>{{$xGstringComiteCambios->USUnombre_usuario}}</td>
                                                    <td>
                                                        @if($xGstringComiteCambios->COMCAestado_comitecambio == 1)
                                                    ...
                                                    <td>
                                                        <div class="btn-group pull-right">
                                                            ...
                                                            <ul class="dropdown-menu pull-right">
                                                                <li>
                                                                    <a href="{{route('RetirarComiteCambio',$xGstringComiteCambios->COMCAid_comitecambio)}}">
